...
const testimonialsHL: Testimonial[] = [
    ...
    },
    {
        ...
        text: "During the critical phase of the LTAF project, Stefan brought people together through swarming and pairing sessions - key to getting it over the line. He consistently demonstrates strong attention to detail, understands both the 'what' and 'why' behind the work, and has the confidence to speak up when something doesn’t feel right. He took full ownership of the Pension Calculator when others moved on, delivering innovative AWS solutions like ephemeral environments for testing and product reviews. His communication is always clear and thorough, and he maintains a strong test-first, quality-driven mindset. He works quickly under pressure but never compromises on standards. On top of that, his curiosity and drive for growth - shown through achievements like his AWS certification - make him a collaborative force who helps the team produce work greater than the sum of its parts.",
        photo: "/photos/Photo_Placeholder_Female.png"
    },
];
